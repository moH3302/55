...
START_IMAGES = [
    {
        ...
        'caption': (
            r'🔥 *Welcome to the Ultimate DDoS Bot\!*' + '\n\n'
            r'💻 *Example:* `20\.235\.43\.9 14533 120 100`' + '\n\n'
            r'💀 *Bsdk threads ha 100 dalo time 120 dalne ke baad* 💀' + '\n\n'
            r'🔑 *Ritik ki ma chodne wala RAJA *' + '\n\n'
            r'⚠️ *RIYAAZ RITIK KA DUSRA BAAP🤬*⚠️' + '\n\n'
            r'⚠️ *DM FOR BUY KEY \- 🤬*⚠️' + '\n\n'
        )
    },
]
...
owner_settings_keyboard = [
    ...
    ['Stop Selected Bot', 'Back to Home']
]
